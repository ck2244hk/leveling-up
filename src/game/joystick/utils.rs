...
use super::{
    VirtualJoystickAction, VirtualJoystickBehavior, VirtualJoystickBundle, VirtualJoystickNode,
...
///     None,
///     None,
///     Some(Color::srgb(0.7, 0.7, 0.2).with_a(0.3)),
///     Vec2::new(75., 75.),
///     Vec2::new(150., 150.),
///     VirtualJoystickNode {
///         dead_zone: 0.,
...
///         ..default()
///     }),
///     BackgroundColor(Color::srgb(0.7, 0.7, 0.2).with_a(0.3)),
/// ))
        ...
        parent.spawn((
            ...
            ImageBundle {
                ...
                style: Style {
                    ...
                    top: Val::Px(knob_size.x / 2.),
                    left: Val::Px(knob_size.y / 2.),
                    ..default()
                },
